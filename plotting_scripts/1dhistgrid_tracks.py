...
# read in He-6 data
he_events_path = (
    "/media/drew/T7 Shield/rocks_analysis/saved_experiments/he6_full_0_aid_1/tracks.csv"
)
he = pd.read_csv(he_events_path, index_col=0)

# read in Ne-19 data
ne_events_path = "/media/drew/T7 Shield/rocks_analysis/saved_experiments/ne19_full_0_aid_2/tracks.csv"
ne = pd.read_csv(ne_events_path, index_col=0)


# ----- Add noise column -----
he["TotalNoise"] = he["TotalPower"] / he["TotalTrackSNR"]
ne["TotalNoise"] = ne["TotalPower"] / ne["TotalTrackSNR"]
...
for feature in features:
    ...
    fig_path = base_path + f"tracks_hist_{feature}_cuts_{cuts}.png"
