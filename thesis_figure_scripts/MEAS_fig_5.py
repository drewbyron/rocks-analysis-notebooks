...
def hist_grid_by_field(
    events_ne, events_he, feature, cuts, normed_cols, nrows, yscale, bins, fig_path="", add_time_length_pdf = False
):
    ...
    #
    group_keys = list(grouped_ne.groups.keys())[2:]
    print(group_keys)
    ...
    for i, (key, ax) in enumerate(targets):
        ...
        ax.set_title(f"field: {key} T. pval = {ks.pvalue:.4f}")
