...
def plot_mon_const_prop_test(b_uncert):
    ...
    ax0.set_title(f"Sensitivity to monitor counts per field per isotope. Mean = {Const.mean()}")
    ...
    plt.savefig(figures_path / Path(f"mon_const_prop.png"), bbox_inches="tight", dpi=300)
    plt.show()
