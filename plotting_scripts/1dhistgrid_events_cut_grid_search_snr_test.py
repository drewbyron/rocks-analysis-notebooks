...
#read in He-6 data
he_events_path = "/media/drew/T7 Shield/rocks_analysis/saved_experiments/he_snr9_fn20_aid_17/events.csv"
he = pd.read_csv(he_events_path, index_col =0)

#read in Ne-19 data
ne_events_path = "/media/drew/T7 Shield/rocks_analysis/saved_experiments/ne_snr9_fn20_aid_20/events.csv"
...
def hist_grid_by_field(ne, he, feature, nrows, yscale, bins, fig_path, cuts = True): 
    ...
    if cuts: 
        ...
        # Apply cuts. 
        he_c = he[(he["EventStartFreq"] > 150e6)& (he["EventNBins"]>100) & (he["mTotalSNR"]>35) ]
        ne_c = ne[(ne["EventStartFreq"] > 150e6)& (ne["EventNBins"]>100) & (ne["mTotalSNR"]>35)]
