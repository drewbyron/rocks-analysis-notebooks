...
fig_name_counts = Path("MC_fig_1_cres_counts_sensitivity.png")
fig_name_mon = Path("MC_fig_2_cres_mon_sensitivity.png")
...
b_uncert = cpc.run_N_const_prop_test(set_fields, freq_BW, exp_max = 4, trial_max = 3 )
cpc.plot_N_const_prop_test(b_uncert, fig_path_counts)

# Run mon const, MC experiments.
b_uncert = cpm.run_mon_const_prop_test(set_fields, freq_BW, exp_max = 4, trial_max = 3 )
cpm.plot_mon_const_prop_test(b_uncert, fig_path_mon)
